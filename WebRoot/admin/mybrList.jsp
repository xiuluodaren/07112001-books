...
function frist()
{
	 ...
	 with (document.getElementById("memberForm")) {
            method = "post";
            action = "<%=path %>/BookServlet?mode=mybrlist&pageNoStr=1";
            submit();
        }
}
...
function back()
{
    ...
    if(pageNo<2){
 	   ...
 	   pageNo=Number(pageNo)-1;
		 ...
		 with (document.getElementById("memberForm")) {
	            method = "post";
	            action = "<%=path %>/BookServlet?mode=mybrlist&pageNoStr="+pageNo;
	            submit();
	        }
}
...
{ 
	   var totlePage='<%=totlePage%>';
		with (document.getElementById("memberForm")) {
            method = "post";
            action = "<%=path %>/BookServlet?mode=mybrlist&pageNoStr="+totlePage;
            submit();
        }
	}
          ...
          <table border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="STYLE1"><div align="center"><img src="images/001.gif" width="14" height="14" onclick="xj()"/></div></td>
                    <td class="STYLE1"><div align="center">续借</div></td>
                  </tr>
              </table></td>
              <td width="52"><table width="88%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="STYLE1"><div align="center"><img src="images/083.gif" width="14" height="14" onclick="deletes()" /></div></td>
                    <td class="STYLE1"><div align="center">归还</div></td>
                  </tr>
              </table></td>
            </tr>
          </table>
