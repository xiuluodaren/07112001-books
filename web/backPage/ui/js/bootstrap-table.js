...
(function ($) {
    ...
    BootstrapTable.prototype.fitHeader = function () {
            ...
            if ($th.length > 0) {
                ...
                if (dataField !== undefined) {
                    ...
                    if ($headerTh.length > 0) {
                        $headerTh.find(":input").addClass("focus-templates.temp");
                    }
                }
            }
        }
        ...
        focusedTemp = $('.focus-templates.temp:visible:eq(0)');
        if (focusedTemp.length > 0) {
            focusedTemp.focus();
            this.$header.find('.focus-templates.temp').removeClass('focus-templates.temp');
        }
